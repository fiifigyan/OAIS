    ...
    <ScrollView>
      <View padding="large">
        ...
        <List.Section>
          ...
          <List.Item
            leading={<Icon name="bell" size={20} color="#03ac13" />}
            trailing={
              <Switch
          ...
          {settings.notificationsEnabled && (
            <>
              <List.Item
                leading={<Icon name="volume-high" size={20} color="#03ac13" />}
                trailing={
                  <Switch
              ...
              <List.Item
                leading={<Icon name="vibrate" size={20} color="#03ac13" />}
                trailing={
                  <Switch
              ...
              <List.Item
                leading={<Icon name="circle" size={20} color="#03ac13" />}
                trailing={
                  <Switch
        ...
        <List.Section>
          ...
          <List.Item
            leading={<Icon name="person" size={20} color="#03ac13" />}
          ...
          <List.Item
            leading={<Icon name="lock" size={20} color="#03ac13" />}
            trailing={<Icon name="chevron-right" size={20} color="#9e9e9e" />}
        ...
        <List.Section>
          ...
          <List.Item
            leading={<Icon name="document-text" size={20} color="#03ac13" />}
            trailing={<Icon name="chevron-right" size={20} color="#9e9e9e" />}
          ...
          <List.Item
            leading={<Icon name="shield-check" size={20} color="#03ac13" />}
            trailing={<Icon name="chevron-right" size={20} color="#9e9e9e" />}
